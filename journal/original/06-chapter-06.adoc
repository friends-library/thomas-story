...
that so very many of them should be suffered to rage upon us to such a degree,
...
so it teacheth all that will receive it, "`to deny ungodliness and worldly lusts,
...
they were not from thenceforth to pay any thing to their ministers for preaching,
