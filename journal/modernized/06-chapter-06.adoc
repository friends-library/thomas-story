...
from henceforth, I began to be afraid of it.
...
and to see what might be the outcome of my inward concern.
...
that as it reproved sin in them, and in all men, so it teaches all that will receive it,
...
and what we might mean by our desiring to see them all together,
...
'`Go into all the earth, and preach the gospel unto every creature: he that believes,
...
One of them repeating the same assertion only as before, I
...
and made a fire, and some of us having biscuit and neats tongue, we ate to satisfaction.
...
in these words, "`Ho, every one that thirsts, come to the waters;
...
and some of them urging me to take a chair, as a better seat,
...
How does it appear that you are such?
...
Go therefore,`" said he, "`and teach all nations,
